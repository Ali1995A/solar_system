...
Status (2026-09-07): material refinement (434e83d) and eclipse demos implemented and checked, with explicit user authorization to push the combined changes. Browser visual acceptance remains pending; online deployment status unverified.
...
- Recommended version: current index.html + surfaces.js + eclipses.js with material refinement and eclipse demos. Material-only milestone: 434e83d. Prior upgrade: add33ef (handoff 7ca983d); original: c791f45. No duplicate release copy was created.
